...
ALLOWED_HOSTS = ["ryuksehen.pythonanywhere.com"]
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'pedidos', # Agrega tu aplicación aquí
]
...
MIDDLEWARE = [
    ...
    'pedidos.middleware.JWTAuthenticationMiddleware',
...
# aqui definimos ajustes de autenticacion para api rest
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'pedidos.api_auth.JwtApiAuthentication',
    ],
